...
from networks.utils.Attention import SD_attn_Cross
from networks.utils.Blocks import Windowattn_Cross_block
...
class LG_Cross_net(nn.Module):
    ...
    def apply_pos_embedding(self, x, pos_x, pos_y):
        pass
