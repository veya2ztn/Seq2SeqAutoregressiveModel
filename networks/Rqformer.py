...
class SwinDecoder(nn.Module):
    ...
    def __init__(self, img_size, patch_size=[1,1], out_chans=20,
                 ...
                 geo_inchans=0, patch_norm=False, local_dec_layers=1):
        super().__init__()
        ...
        self.imnet = Siren(in_features=embed_dim+3, out_features=embed_dim, hidden_features=[embed_dim*4, embed_dim, embed_dim*4], hidden_layers=2, outermost_linear=True)
