#!/bin/sh
#SBATCH -J F7066A      # 作业在调度系统中的作业名为myFirstJob;
#SBATCH -o log/%j-F7066A.out  # 脚本执行的输出将被保存在20210827-%j.out文件下，%j表示作业号;
#SBATCH -e log/%j-F7066A.out  # 脚本执行的输出将被保存在20210827-%j.out文件下，%j表示作业号;
...
#python optuna_run.py --train_set 2D706N --dataset_type WeathBench7066 --time_step 3 --epoch 100 --mode pretrain --dataset_flag 3D70U --save_warm_up 1000 --wrapper_model ConVectionModel --debug 0 --use_amp 0
