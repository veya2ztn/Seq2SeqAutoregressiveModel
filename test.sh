...
do
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7;python mytool.py --level 0 --mode fourcast --do_error_propagration_monitor 20 --use_wandb off --force_fourcast 1 --fourcast_step 22 --paths $THEPATH
done 
